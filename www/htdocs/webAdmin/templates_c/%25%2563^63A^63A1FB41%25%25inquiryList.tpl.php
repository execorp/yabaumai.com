<?php /* Smarty version 2.6.25, created on 2022-06-28 18:21:29
         compiled from inquiryList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'inquiryList.tpl', 28, false),)), $this); ?>
...
<?php $_from = $this->_tpl_vars['prtData']['inquiry']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['result'] = array('total' => count($_from), 'iteration' => 0);
...
?>
            <tr>
                ...
                <td vAlign="middle" nowrap="nowrap"><?php echo $this->_tpl_vars['value']['name']; ?>
</td>
                <td vAlign="middle" width="100%"><a href="mailto:<?php echo $this->_tpl_vars['value']['eMail']; ?>
"><?php echo $this->_tpl_vars['value']['eMail']; ?>
</a></td>
                <td nowrap="nowrap"><form action="./inquiryAddChange.php" method="post"><input type="submit" name="change" value="詳細"><input type="hidden" name="inquiryId" value="<?php echo $this->_tpl_vars['value']['inquiryId']; ?>
"></form></td>
                <td nowrap="nowrap"><form action="./inquiryList.php" method="post"><input type="checkbox" name="delChk" value="<?php echo $this->_tpl_vars['value']['inquiryId']; ?>
"><input type="submit" name="del" value="削除"><input type="hidden" name="inquiryId" value="<?php echo $this->_tpl_vars['value']['inquiryId']; ?>
"></form></td>
