...
class Thumbnail {
    ...
    function showErrorImage($maxWidth, $maxHeight, $noimg) {
        ...
        $bgColor = imagecolorallocate($errImg,33,33,33);
        $fgColor1 = imagecolorallocate($errImg,255,200,0);
        ...
        switch($noimg){
        	...
        	case 2:ImageTTFText($errImg, 12, 20, ($maxWidth/2)-36, $maxHeight/2+20, $fgColor1, "./font/GOTHICB.TTF",$this->errmsg);break;
        	case 3:
        		...
        		if(@filesize($file)){
        			...
        			imagestring($errImg,12,($maxWidth/2)-34,$maxHeight/2-7,$this->errmsg,$fgColor1);
        		}
        	break;
...
/* 透過対応リサイズ処理拡張 */
	 ...
	 * @param string $name
	 */
	function show($quality=100,$name = '', $mode = 1) {
		if($mode == 3){
			if($name != '') {
