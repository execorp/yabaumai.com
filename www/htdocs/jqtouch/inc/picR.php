 ...
 *  [cache] キャッシュ使用モード ('1' => 一次キャッシュ有効, '2' => 二次キャッシュ有効, '3' => キャッシュ無効 )
...
if(CACHE != 3){
	if(PARCENT > 0){
		...
		$cacheName = 'c' . CONTENTS_NUM . '-' . basename(FILE_NAME) . '_' . MAX_WIDTH . 'x' . MAX_HEIGHT . '_q' . QUALITY . '_rs' . RESIZE;
	}
